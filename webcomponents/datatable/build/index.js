...
import { throttler as l } from '@trvt/assets';
import i from './styles-30a5a840.css' assert { type: 'css' };
...
class u extends HTMLElement {
	constructor() {
		super(),
			...
			(this.shadowRoot.adoptedStyleSheets = [...s, i]),
			(this.numberOfRows =
			...
			CSS.supports('container', 'test / inline-size') ||
				window.addEventListener(
					'resize',
					l(this.setRotationProperties, 300, this)
				);
	}
